...
var ASSETS = "/packages/maxkferg_pdfjs/meteor/"
...
// We need to wait for the template to be rendered
// Instead of using DOMContentLoaded we user the meteor templating event
// This is now done in the main appliaction code
...
// Export the load and change function to the global object
// We use an alias to avoid issues with var
LuminViewer = PDFViewerApplication; 
LuminViewer.init = function(url){
  webViewerLoad(url)
}

LuminViewer.change = function(url){
